...
import static com.yp.algorithms.graphtheory.treealgorithms.TreeCenter.addUndirectedEdge;
import static com.yp.algorithms.graphtheory.treealgorithms.TreeCenter.createEmptyTree;
import static com.yp.algorithms.graphtheory.treealgorithms.TreeCenter.findTreeCenters;
  ...
  public void testTreeCenterVsOtherImpl() {
    for (int n = 1; n < 500; n++) {
      for (int loops = 0; loops < 100; loops++) {
        ...
        List<Integer> impl2 =
            com.yp.algorithms.graphtheory.treealgorithms.TreeCenterLongestPathImpl
