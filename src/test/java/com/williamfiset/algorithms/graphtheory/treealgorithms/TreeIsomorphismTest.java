...
import static com.yp.algorithms.graphtheory.treealgorithms.TreeIsomorphism.addUndirectedEdge;
import static com.yp.algorithms.graphtheory.treealgorithms.TreeIsomorphism.createEmptyGraph;
import static com.yp.algorithms.graphtheory.treealgorithms.TreeIsomorphism.treesAreIsomorphic;
  ...
  public void testIsomorphismEquivilanceAgainstOtherImpl() {
    for (int n = 1; n < 50; n++) {
      for (int loops = 0; loops < 1000; loops++) {
        ...
        boolean impl2 =
            com.yp.algorithms.graphtheory.treealgorithms.TreeIsomorphismWithBfs
